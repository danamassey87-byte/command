...
export default function BuyerSOP() {
  ...
  // The ONE canonical checklist for the selected deal (shared with the Buyers
  // page + Pipeline).
      ...
      {checklistKey ? (
        ...
        <Card className="seller-sop__stage">
          <p style={{ margin: 0, fontSize: '0.85rem', color: 'var(--brown-warm, #5A4136)' }}>
            Select a deal above to view its checklist. This is the same buyer checklist shown on the
            Buyers page and in the Pipeline — check a box in any of them and it updates everywhere.
