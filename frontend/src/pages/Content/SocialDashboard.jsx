...
const ALL_PLATFORMS = [
  ...
  { key: 'realtor_com',  label: 'Realtor.com',     icon: '🔑', color: '#D92228', group: 'reviews', defaultHandle: 'Your Profile',
    nativeSupport: false, apifyActor: null },
  { key: 'blog',         label: 'Blog',            icon: '✍️',  color: '#3A2A1E', group: 'web', defaultHandle: 'yourblog.com',
    nativeSupport: false, apifyActor: null },
  { key: 'website',      label: 'Website',         icon: '🌐', color: '#3A2A1E', group: 'web', defaultHandle: 'yoursite.com',
    nativeSupport: false, apifyActor: null },
